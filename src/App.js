...
function Welcome(props){
  return <h1>Welcome to Movie Form!</h1>
}
...
class App extends Component  {
  ...
  // create simple method here to remove a movie
  ...
  // create simple method to add a movie
  ...
  //you always have to render a function in a component
  render (){
    ...
    return (
      <div className="container">
        ...
        <DeleteAll removeAllMovies={this.removeAllMovies} />
      </div>
    )
  }
}
